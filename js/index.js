...
$(document).ready(function() 
{
    ...
    // fixing tabs remaining active even when not needed * * * http://stackoverflow.com/questions/16752704/tab-active-state-in-jquery-mobile
    $('.tabs').click( function(e) {
        e.preventDefault();
        $('.tabs').removeClass('ui-btn-active ui-state-persist');
    });
...
function displayPost(data) 
{
    ...
    $(".pageLink").on("click", function()
    {
        ...
        { 
            ...
            console.log('catbutton clicked' + catName);
        });
