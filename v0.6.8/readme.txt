...
Version 0.6.4
- Home page functionality now working
- Start on scrolling menu made

Version 0.6.4
- Scrolling Menu finished
- Major changes to endpoint calls
- Moved to custom categories endpoint 

Version 0.6.5
- Responsive layout
- 2nd column on wider screens
