 ...
 * @return {deferred promise} deferred promise onject from ajax call
 */
function getJSON(JSONurl, parameters) 
{
    ...
    return $.ajax({
            ...
            success: function(data) 
            {
                ...
                {
                    console.log("len " + data.length + " < per page  " + GLOBAL_perPage)
...
function updateCategories(data) 
{
    ...
    {
        ITNCats.push({"catName" : oneJSONCat.name, "catID" : oneJSONCat.id });        
    });
...
function addCategoriesToMenu()
{
    ...
    {
        //$("#allCatsList").append('<li><a data-catname="' + oneCat.catName + '"href = "#main" class ="cats" id = "' + oneCat.catID + '">' + oneCat.catName + '</a></li><a href="#" >Purchase album</a>').listview("refresh");
        $("#allCatsList").append('<li><a href="#main" class="cats" data-catname="' + oneCat.catName + '" id = "' + oneCat.catID + '">' + oneCat.catName + '</a><a data-blank="true" data-icon="blank" class="favouriteToggle" >Delete</a></li>').listview("refresh");
    });
